Ext.define('Admin.view.profile.Description', {
    ...
    items: [
        ...
        },
        {
            ...
            html: 'Registered since 1 years ago',
            padding: '0 0 12 0'
        },
        {
            xtype: 'component',
            baseCls: 'box x-fa fa-globe',
            html: '<a href="http://girocheck.com/"\'>http://girocheck.com</a>',
            padding: '0 0 12 0'
        },
//        {
//            xtype: 'container',
//            flex: 1,
//            cls: 'about-me-wrap',
//            html: '<h3 class="x-fa fa-user">About</h3><p>Lorem ipsum sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.</p>'
//        },
//        {
//            xtype:'toolbar',
//            ui: 'plain',

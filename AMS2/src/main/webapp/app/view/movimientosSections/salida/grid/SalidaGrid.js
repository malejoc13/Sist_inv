Ext.define('Admin.view.movimientosSections.salida.grid.SalidaGrid', {
    extend: 'Admin.base.BasePaginatedGrid',
    alias: 'widget.salidaGrid',
    columns: {
        defaults: {
            align: 'center'
        },
    ...
    getParams: function () {//redefino la funcion para que cargue por el tipo de mov deseado
         var me = this,
            ...
            searchParams = me.up().staticFilters + '@is@(I)' +2;//en caso de ser entradas
